  ...
  load("./Outputs/RSF_output/Kfold_CV/md_kfold_smr_2022-06-13.RData") #2022-06-13/14 is weighted and global version 
  ...
  save(coug_smr_OK_Kpredict, file = paste0("./Outputs/RSF_output/Kfold_CV/coug_smr_OK_Kpredict_", Sys.Date(), ".RData"))
  ...
  save(coug_smr_NE_Kpredict, file = paste0("./Outputs/RSF_output/Kfold_CV/coug_smr_NE_Kpredict_", Sys.Date(), ".RData"))
  ...
  save(coug_wtr_OK_Kpredict, file = paste0("./Outputs/RSF_output/Kfold_CV/coug_wtr_OK_Kpredict_", Sys.Date(), ".RData"))
  ...
  save(coug_wtr_NE_Kpredict, file = paste0("./Outputs/RSF_output/Kfold_CV/coug_wtr_NE_Kpredict_", Sys.Date(), ".RData"))
  ...
  save(wolf_smr_OK_Kpredict, file = paste0("./Outputs/RSF_output/Kfold_CV/wolf_smr_OK_Kpredict_", Sys.Date(), ".RData"))
  ...
  save(wolf_smr_NE_Kpredict, file = paste0("./Outputs/RSF_output/Kfold_CV/wolf_smr_NE_Kpredict_", Sys.Date(), ".RData"))
  ...
  save(wolf_wtr_OK_Kpredict, file = paste0("./Outputs/RSF_output/Kfold_CV/wolf_wtr_OK_Kpredict_", Sys.Date(), ".RData"))
